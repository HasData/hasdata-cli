...
func newGoogleSerpLightCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(c *cobra.Command, _ []string) error {
			...
			resp, err := cli.Do(ctx, "GET", "https://api.hasdata.com/scrape/google-light/serp", params, nil)
			if err != nil {
				return err
			}
...
func init() {
	RegisterAPICommand("google_serp", "Google SERP", newGoogleSerpLightCmd())
}
